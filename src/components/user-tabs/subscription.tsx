            ...
            setFormData({
                ...
                subscription: {
                    ...
                    package: {
                        ...
                        price_per_unit:
                            user.subscription.package.price_per_unit,
                        // name: "",
                        // days_count: 0,
                    },
                    category: {
                        ...
                        <>
                            <div className="col-span-12">
                                {
                                    <SelectInput
                                        ...
                                        itemValue="id"
                                        value={
                                            formData.subscription.category.id
                                        }
                                        label=" نوع الخدمة"
                                    ></SelectInput>
                                }
                            ...
                            <div className="col-span-6">
                                <SelectInput
                                    ...
                                    itemName="name_ar"
                                    itemValue="id"
                                    value={formData.subscription.package.id}
                                    label=" نوع الباقة"
                                ></SelectInput>
                            </div>
                            ...
                            <div className="col-span-6">
                                <SelectInput
                                    ...
                                    itemName="name_ar"
                                    itemValue="id"
                                    value={formData.subscription.district.id}
                                    items={district}
                                    label="اسم المنطقة"
                                ></SelectInput>
