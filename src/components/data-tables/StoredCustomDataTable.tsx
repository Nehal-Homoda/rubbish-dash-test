                    ...
                    <th key={index} scope="col" className="px-4 py-5 ">
                      <div className="flex gap-2 text-nowrap font-bold">
                        <div className="flex flex-col cursor-pointer space-y-0 justify-center items-center leading-none ">
                          ...
                          <div onClick={() => [handleSort(item, 'asc'), setIsUpActive(true), setIsDownActive(false)]} className={`arrow-img-wrap w-2 h-2  ${!isUpActive ? 'opacity-40' : 'opacity-90'}`}>
                            <img className="arrow-img w-full h-full object-contain rotate-180" src={arrowImage.src} alt="" />
                          </div>

                          <div onClick={() => [handleSort(item, 'desc'), setIsDownActive(true), setIsUpActive(false)]} className={`arrow-img-wrap w-2 h-2  ${!isDownActive ? 'opacity-40' : 'opacity-90'}`}>
